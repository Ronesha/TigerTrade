...
.jpets{
  ...
  width:100%;
  color:#fff;
  background: url('../img/automotive2.jpeg');
  height:50vh;
    ...
    <div class="col-md-3">
      <div class="borderBox">
         ...
         <div class="list-group">
            ...
            <a href="automotive.php" class="list-group-item list-group-item-action active">Automotive</a>
   ...
   <!--Top Categories list-->
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
          <img src="../img/Automotive/car4.jpeg" width="100%" height="225">
        <div class="card-body">
          <h5>For Sale</h5>
          <div class="d-flex justify-content-between align-items-center">
            <p>Good condition. Asking for $4000 OBO. Clean Title </p>
...
<div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Automotive/car5.jpeg" width="100%" height="225">
        <div class="card-body">
            <h5>For sale</h5>
             <div class="d-flex justify-content-between align-items-center">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Automotive/car3.jpeg" width="100%" height="225">
        <div class="card-body">
            <h5>For Sale</h5>
            <div class="d-flex justify-content-between align-items-center">
            <p>Asking for $6000 OBO</p>
            <small class="text-muted">9 mins</small>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
          <img src="../img/Automotive/car1.jpeg" width="100%" height="225">
        <div class="card-body">
          <h5>BMW</h5>
          <div class="d-flex justify-content-between align-items-center">
...
<div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Automotive/automotive.jpeg" width="100%" height="225">
        <div class="card-body">
            <h5>For sale</h5>
             <div class="d-flex justify-content-between align-items-center">
           <p>Contact for more information</p>
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Automotive/automotive2.jpeg" width="100%" height="225">
        <div class="card-body">
            <h5>For Sale</h5>
            <div class="d-flex justify-content-between align-items-center">
           <p>Contact for more info</p>
