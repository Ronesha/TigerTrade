    ...
    <div class="col-md-3">
      <div class="borderBox">
         ...
         <div class="list-group">
            ...
            <a href="pets.php" class="list-group-item list-group-item-action active">Pets</a>
         </div>
   ...
   <!--Top Categories list-->
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
          <img src="../img/Pets/pet2.jpg" width="100%" height="225">
        <div class="card-body">
          <h5>Dog Bowls</h5>
...
<div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Pets/pet.jpg" width="100%" height="225">
        <div class="card-body">
            <h5>Dog Bones</h5>
             <div class="d-flex justify-content-between align-items-center">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Pets/pet5.jpg" width="100%" height="225">
        <div class="card-body">
            <h5> Cage For Sale </h5>
            <div class="d-flex justify-content-between align-items-center">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
          <img src="../img/Pets/pet3.jpg" width="100%" height="225">
        <div class="card-body">
          <h5>Dog Bed For Sale</h5>
          <div class="d-flex justify-content-between align-items-center">
...
<div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Pets/pet4.jpg" width="100%" height="225">
        <div class="card-body">
            <h5>For Sale</h5>
             <div class="d-flex justify-content-between align-items-center">
           <p>Contact for more info</p>
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img src="../img/Pets/pet6.jpg" width="100%" height="225">
        <div class="card-body">
            <h5>For Sale</h5>
            <div class="d-flex justify-content-between align-items-center">
           <p>Contact for more info</p>
